...
export const styles: { [key: string]: CSSProperties } = {
  ...
  // --- מסך לובי (Lobby) - תיקון מרכוז וגודל ---
  lobbyCenterArea: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', width: '100%', flex: 1 },
  lobbyButton: { width: '100%', minHeight: '54px', padding: '12px', borderRadius: '16px', background: 'linear-gradient(135deg, #ffd700, #b8860b)', color: '#05081c', fontWeight: '900', border: 'none', cursor: 'pointer', fontSize: '1.2rem' },
  lobbyJoinFrame: { width: '100%', minHeight: '100px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255, 255, 255, 0.03)', borderRadius: '24px', border: '2px dashed rgba(255, 215, 0, 0.3)', cursor: 'pointer' },

  // --- מסך אפיון (Setup) - נשאר עם הפרופורציות החדשות ---
