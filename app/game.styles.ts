...
export const styles: { [key: string]: CSSProperties } = {
  ...
  setupHeader: { display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', gap: '10px', marginTop: '45px', marginBottom: '10px' },
  ...
  setupGrid: { display: 'grid', gap: '8px', width: '100%', flex: 1, margin: '15px 0', alignContent: 'start' },
  teamBox: { backgroundColor: 'rgba(255, 255, 255, 0.04)', borderRadius: '18px', border: '1px solid rgba(255,215,0,0.1)', padding: '10px', display: 'flex', flexDirection: 'column', minHeight: '140px', position: 'relative' },
  minusBtnCentered: { width: '60px', height: '60px', borderRadius: '50%', backgroundColor: 'rgba(239, 68, 68, 0.15)', border: '2px solid #ef4444', color: '#ef4444', fontSize: '30px', fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', margin: 'auto' },
  playerCard: { backgroundColor: 'rgba(255, 255, 255, 0.1)', color: 'white', padding: '10px', borderRadius: '12px', margin: '4px 0', fontSize: '0.85rem', textAlign: 'center', fontWeight: 'bold' },
  lobbyButton: { width: '100%', minHeight: '60px', borderRadius: '20px', backgroundColor: '#ffd700', color: '#05081c', fontWeight: '900', border: 'none', fontSize: '1.4rem', cursor: 'pointer', boxShadow: '0 4px 15px rgba(255, 215, 0, 0.2)' },
