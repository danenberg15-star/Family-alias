...
export const styles: { [key: string]: CSSProperties } = {
  ...
  // לובי
  roomButton: { width: COMMON_WIDTH, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '15px', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '16px', color: 'white', marginBottom: '10px' },
  ...
  skipButton: { width: COMMON_WIDTH, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '10px', borderRadius: '12px', border: '2px solid #ef4444', color: 'white', cursor: 'pointer', transition: 'all 0.1s' },
  guesserButton: { width: COMMON_WIDTH, display: 'flex', alignItems: 'center', gap: '10px', padding: '12px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', transition: 'all 0.1s' },
