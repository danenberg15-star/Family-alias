...
export const styles: { [key: string]: CSSProperties } = {
  ...
  safeAreaWrapper: { 
    ...
    justifyContent: 'space-between' // הקסם כאן: מפזר את התוכן לאורך כל המסך
  },
  flexLayout: { 
  ...
  // לוגו וטקסט
  entryLogo: { width: 'min(240px, 65vw)', height: 'auto', maxHeight: '25vh', objectFit: 'contain' },
  ...
  entryInput: { 
    ...
    fontSize: '1.2rem', textAlign: 'center', boxSizing: 'border-box' 
  },
  
  // כפתורים
  lobbyButton: { 
    width: '100%', minHeight: '60px', borderRadius: '18px', backgroundColor: '#ffd700', 
