...
export default function FamilyAliasApp() {
  ...
  return (
    <div style={styles.container} onPointerMove={handlePointerMove} onPointerUp={() => {
      ...
      <button onClick={() => { localStorage.clear(); window.location.reload(); }} style={{ position: 'fixed', bottom: 10, left: 10, opacity: 0.1, background: 'none', border: 'none', color: 'white', fontSize: '10px' }}>Reset App</button>
    </div>
  );
}