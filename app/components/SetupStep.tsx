    ...
    <div style={{ ...styles.stepContainer, overflowY: "auto", paddingBottom: "100px" }}>
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
        <button
          ...
          style={{
            ...styles.btn,
            backgroundColor: gameMode === "individual" ? "#ffd700" : "#333",
            color: gameMode === "individual" ? "#000" : "#fff",
          }}
        >
          יחידים
        </button>
            ...
            {[2, 3, 4].map((n) => (
              <button
                ...
                style={{
                  ...styles.btn,
                  fontSize: "14px",
                  backgroundColor: numTeams === n ? "#ffd700" : "#333",
                  color: numTeams === n ? "#000" : "#fff",
                }}
              >
                {n} קבוצות
              </button>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px", width: "100%" }}>
            {teamNames.slice(0, numTeams).map((name, idx) => (
              <div
                key={idx}
                ref={(el) => {
                  if (teamsRef.current) teamsRef.current[idx] = el;
                }}
      ...
      {gameMode === "individual" && (
        <div style={{ width: "100%", marginTop: "20px" }}>
          <h2 style={{ fontSize: "18px", marginBottom: "10px" }}>שחקנים בחדר:</h2>
      ...
      <button onClick={onStart} style={{ ...styles.hugePlayBtn, marginTop: "30px" }}>
        🚀 התחל משחק!
      </button>
    </div>
  );
