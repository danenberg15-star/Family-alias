  ...
  return (
    <div style={styles.stepContainer}>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "flex-end", padding: "10px" }}>
        <button onClick={onPause} style={{ ...styles.btn, backgroundColor: "rgba(255,255,255,0.1)", color: "#fff", fontSize: "14px" }}>
          ⏸️ השהה
        </button>
      </div>

      {/* טיימר גדול */}
      <div style={{ fontSize: "60px", fontWeight: "900", color: timeLeft <= 10 ? "#ff4444" : "#ffd700", marginTop: "20px" }}>
        {timeLeft}
      </div>

      <div style={{ flex: 1, position: "relative", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        
        {/* אזורי המטרה לניחוש (שמות שחקנים או קבוצות) */}
        ...
        <div
          ...
          style={{
            ...
            color: "#000",
            cursor: "grab",
            boxShadow: isDraggingWord ? "0 10px 30px rgba(0,0,0,0.5)" : "0 4px 10px rgba(0,0,0,0.2)",
            zIndex: 10,
            touchAction: "none",
          }}
        >
        ...
        <div
          ...
          style={{
            ...
            borderRadius: "50px",
            border: "2px solid",
            borderColor: activeHover === "SKIP" ? "#ff4444" : "rgba(255,255,255,0.2)",
      ...
      <div style={{ fontSize: "20px", marginBottom: "20px", color: "rgba(255,255,255,0.6)" }}>
        ניקוד בסיבוב: <span style={{ color: "#ffd700", fontWeight: "bold" }}>{score}</span>
      </div>
    </div>
  );
};
